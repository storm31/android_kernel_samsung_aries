...
#else // CONFIG_MACH_P1
	SAVE_ITEM(MAX8998_REG_BUCK1_DVSARM1),
	SAVE_ITEM(MAX8998_REG_BUCK1_DVSARM2),
	SAVE_ITEM(MAX8998_REG_BUCK1_DVSARM3),
	SAVE_ITEM(MAX8998_REG_BUCK1_DVSARM4),
	SAVE_ITEM(MAX8998_REG_BUCK2_DVSINT1),
	SAVE_ITEM(MAX8998_REG_BUCK2_DVSINT2),
#endif

...
const char * const *isx005_ctrl_get_menu(u32 id)
{
	switch (id)
	{
		default:
 ...
 *
 * */
static int isx005_s_mbus_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)
{
	struct isx005_state *state = to_state(sd);
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int isx005_enum_mbus_fmt(struct v4l2_subdev *sd, unsigned int index,
...
static int isx005_try_mbus_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)
{
	int num_entries = 0;
	int i = 0;
...
static const struct v4l2_subdev_video_ops isx005_video_ops = {
	...
	.enum_mbus_fmt = isx005_enum_mbus_fmt,
	.try_mbus_fmt = isx005_try_mbus_fmt,
			 ...
			 const struct i2c_device_id *id)
{
	...
	struct v4l2_subdev *sd;
	struct isx005_platform_data *pdata = client->dev.platform_data;
...
static struct i2c_driver v4l2_i2c_driver = {
	.driver.name = ISX005_DRIVER_NAME,
	.probe = isx005_probe,
